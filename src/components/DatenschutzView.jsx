      ...
      <div className="legal__body">
        ...
        <section className="legal__block">
          ...
          <p>
            ...
            technische Zugriffsdaten in Server-Logfiles erfasst (IP-Adresse, Datum und
            Uhrzeit, abgerufene URL, übertragene Datenmenge, Browser-Typ und -Version,
            Betriebssystem, Referrer-URL). Diese Daten dienen ausschliesslich der
            Sicherstellung des Betriebs und werden nicht mit anderen Datenquellen verknüpft.
          </p>
          <p>
            Bei einer Kontaktaufnahme per E-Mail oder Telefon werden die uns mitgeteilten
            Daten zur Beantwortung der Anfrage und für mögliche Folgekommunikation
            gespeichert.
          </p>
        </section>
        ...
        <section className="legal__block">
          ...
          <p>
            ...
            Diese Website verwendet derzeit keine Cookies, die über die technische Funktion
            der Seite hinausgehen. Es findet keine Auswertung des Nutzerverhaltens statt.
          </p>
        </section>
        ...
        <section className="legal__block">
          ...
          <p>
            ...
            Schriftarten werden direkt von unserem Server ausgeliefert. Es werden keine
            Drittanbieter-CDNs für Schriften, Skripte oder Stilvorlagen eingebunden.
          </p>
        </section>
        ...
        <section className="legal__block">
          <h2>5. Ihre Rechte</h2>
          <p>
            Sie haben das Recht, jederzeit unentgeltlich Auskunft über Ihre bei uns
            gespeicherten Personendaten zu verlangen. Zudem können Sie deren Berichtigung,
            Sperrung oder Löschung verlangen, soweit keine gesetzlichen
            Aufbewahrungspflichten entgegenstehen. Bei Verstössen können Sie sich an den
        ...
        <section className="legal__block">
          ...
          <p>
            Diese Website nutzt SSL/TLS-Verschlüsselung. Eine Datenübertragung erfolgt
            verschlüsselt. Wir treffen technische und organisatorische Massnahmen, um Ihre
            Daten gegen zufällige oder vorsätzliche Manipulation, Verlust oder Zerstörung zu
            schützen.
          </p>
        </section>
        ...
        <section className="legal__block">
          ...
          <p>
            ...
            Massgebend ist die jeweils aktuelle, auf dieser Website veröffentlichte Fassung.
          </p>
        </section>
      </div>
    </section>
